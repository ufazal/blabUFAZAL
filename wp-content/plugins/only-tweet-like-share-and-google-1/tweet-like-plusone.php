...
?>
	...
	<p><b>3 </b><input type="checkbox" name="s4_plusone" id="s4-plusone" value="true"<?php if (get_option( 's4_plusone', true ) == true) echo ' checked'; ?>> <?php _e('Display Google +1','only-tweet-like-share-and-google-1'); ?> </p>
	...
	<tr><td>
	<?php _e('If you have successfully added a custom button to your site then please help others by posting the custom code in the','only-tweet-like-share-and-google-1'); ?> <a target="_blank" href="http://techxt.com/plugin-support-forum/tweet-like-plusone-and-share-plugin/"><?php _e('Plugin Forum','only-tweet-like-share-and-google-1'); ?></a>.
	</td></tr>
	<tr><td>
...
function removeconflict()
{
	...
	{
		$a=get_user_meta( get_current_user_id(), "wpseo_dismissed_conflicts", true );
		if (!is_array($a)||!in_array('only-tweet-like-share-and-google-1/tweet-like-plusone.php',$a["open_graph"]))
		{
			$a["open_graph"][] = 'only-tweet-like-share-and-google-1/tweet-like-plusone.php';
			update_user_meta( get_current_user_id(),"wpseo_dismissed_conflicts", $a );
		}

	}
}
add_action( 'admin_init', 'removeconflict',9);
...
function display_social4i($size,$align, $type = FALSE)
{
	...
	$btnarrver[2]='<div class="socialiconsv s4fblikev" ><iframe src="//www.facebook.com/plugins/like.php?href='.$plink.'&amp;send=false&amp;layout=box_count&amp;width=51&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=65" style="border:none; overflow:hidden; width:51px; height:65px;"></iframe></div>';
	}
