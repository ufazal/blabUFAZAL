...
* @license http://framework.zend.com/license/new-bsd   New BSD License
*/
abstract class mail_bank_Zend_Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator
{
	/**
	...
	* @var string
	*/
	protected $_messageClass = 'mail_bank_Zend_Mail_Message';
	...
	*
	* @param int $id number of message
	* @return mail_bank_Zend_Mail_Message
	*/
	...
	*
	* @param int $id
	* @return mail_bank_Zend_Mail_Message message object
	*/
	...
	* Iterator::current()
	*
	* @return mail_bank_Zend_Mail_Message current message
	*/
