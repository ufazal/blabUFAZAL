...
* @license    http://framework.zend.com/license/new-bsd     New BSD License
*/
class mail_bank_Zend_Mail_Storage_Folder implements RecursiveIterator
{
	/**
	* subfolders of folder array(localName => mail_bank_Zend_Mail_Storage_Folder folder)
	* @var array
	*/
	protected $_folders;
	...
	* @param array  $folders    init with given instances of mail_bank_Zend_Mail_Storage_Folder as subfolders
	*/
	...
	*/
	public function hasChildren()
	{
		...
		return $current && $current instanceof mail_bank_Zend_Mail_Storage_Folder && !$current->isLeaf();
	}

	/**
	* implements RecursiveIterator::getChildren()
	*
	* @return mail_bank_Zend_Mail_Storage_Folder same as self::current()
	*/
	...
	*
	* @return mail_bank_Zend_Mail_Storage_Folder current folder
	*/
	...
	* @return mail_bank_Zend_Mail_Storage_Folder folder named $folder
	...
	* @param mail_bank_Zend_Mail_Storage_Folder $folder instance for new subfolder
	* @return null
	*/
	public function __set($name, mail_bank_Zend_Mail_Storage_Folder $folder)
	{
