...
/**
* @see mail_bank_Zend_Mail_Storage_Folder
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/folder.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/folder.php';

/**
* @see mail_bank_Zend_Mail_Storage_Folder_Interface
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/folder/interface.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/folder/interface.php';

/**
* @see mail_bank_Zend_Mail_Storage_Maildir
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/maildir.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/maildir.php';
...
* @license  http://framework.zend.com/license/new-bsd  New BSD License
*/
class mail_bank_Zend_Mail_Storage_Folder_Maildir extends mail_bank_Zend_Mail_Storage_Maildir implements mail_bank_Zend_Mail_Storage_Folder_Interface
{
	/**
	* mail_bank_Zend_Mail_Storage_Folder root folder for folder structure
	* @var mail_bank_Zend_Mail_Storage_Folder
	*/
	...
	*
	* Result is save in mail_bank_Zend_Mail_Storage_Folder instances with the root in $this->_rootFolder.
	...
	*/
	protected function _buildFolderTree()
	{
		...
		$this->_rootFolder->INBOX = new mail_bank_Zend_Mail_Storage_Folder('INBOX', 'INBOX', true);
	...
	* @return mail_bank_Zend_Mail_Storage_Folder root or wanted folder
	* @throws mail_bank_Zend_Mail_Storage_Exception
	*/
	...
	*
	* @param mail_bank_Zend_Mail_Storage_Folder|string $globalName global name of folder or instance for subfolder
	* @return null
	* @throws mail_bank_Zend_Mail_Storage_Exception
	*/
	...
	/**
	* get mail_bank_Zend_Mail_Storage_Folder instance for current folder
	*
	* @return mail_bank_Zend_Mail_Storage_Folder instance of current folder
	* @throws mail_bank_Zend_Mail_Storage_Exception
	*/
