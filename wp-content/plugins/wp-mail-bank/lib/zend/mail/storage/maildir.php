...
/**
* @see mail_bank_Zend_Mail_Storage_Abstract
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/abstract.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/storage/abstract.php';

/**
* @see mail_bank_Zend_Mail_Message_File
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/message/file.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/message/file.php';

/**
* @see mail_bank_Zend_Mail_Storage
*/
if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mail/storage.php'))
require_once MAIL_BANK_DIR_PATH.'lib/zend/mail/storage.php';
...
* @license http://framework.zend.com/license/new-bsd	  New BSD License
*/
class mail_bank_Zend_Mail_Storage_Maildir extends mail_bank_Zend_Mail_Storage_Abstract
{
	/**
	* used message class, change it in an extened class to extend the returned message class
	* @var string
	*/
	protected $_messageClass = 'mail_bank_Zend_Mail_Message_File';
	...
	* @var array
	*/
	protected static $_knownFlags = array('D' => mail_bank_Zend_Mail_Storage::FLAG_DRAFT,
													'F' => mail_bank_Zend_Mail_Storage::FLAG_FLAGGED,
													'P' => mail_bank_Zend_Mail_Storage::FLAG_PASSED,
													'R' => mail_bank_Zend_Mail_Storage::FLAG_ANSWERED,
													'S' => mail_bank_Zend_Mail_Storage::FLAG_SEEN,
													'T' => mail_bank_Zend_Mail_Storage::FLAG_DELETED);
	...
	* @return mail_bank_Zend_Mail_Message_File
	* @throws mail_bank_Zend_Mail_Storage_Exception
	*/
