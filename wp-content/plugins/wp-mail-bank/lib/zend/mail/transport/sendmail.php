...
class mail_bank_Zend_Mail_Transport_Sendmail extends mail_bank_Zend_Mail_Transport_Abstract
{
	...
	* @access public
	* @return void
	* @throws mail_bank_Zend_Mail_Transport_Exception if parameters is set
	*			but not a string
	...
	* @param	array $headers
	* @return  void
	* @throws  mail_bank_Zend_Mail_Transport_Exception
	*/
	protected function _prepareHeaders($headers)
	{
		if (!$this->_mail)
		{
			...
			*/
			...
			throw new mail_bank_Zend_Mail_Transport_Exception('_prepareHeaders requires a registered Zend_Mail object');
		}
