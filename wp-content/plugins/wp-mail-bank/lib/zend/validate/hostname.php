...
class mail_bank_Zend_Validate_Hostname extends mail_bank_Zend_Validate_Abstract
{
	...
	*/
	...
	/**
		* @param mail_bank_Zend_Validate_Ip $ipValidator OPTIONAL
		* @return mail_bank_Zend_Validate_Hostname
	*/
	public function setIpValidator(mail_bank_Zend_Validate_Ip $ipValidator = null)
	{
		if($ipValidator === null)
		{
			$ipValidator = new mail_bank_Zend_Validate_Ip();
		}
