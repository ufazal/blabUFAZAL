...
require_once MAIL_BANK_DIR_PATH.'lib/zend/mime/message.php';
...
class mail_bank_Zend_Mail extends mail_bank_Zend_Mime_Message
{
	...
	*/
	...
	/**
		...
		* @param	mail_bank_Zend_Mail_Transport_Abstract $transport
	*/
	...
	*/
	...
	/**
		...
		*
		* @param	mail_bank_Zend_Mime_Part $attachment
		* @return mail_bank_Zend_Mail Provides fluent interface
	*/
	...
	*/
	public function createAttachment($body,
												$mimeType    = mail_bank_Zend_Mime::TYPE_OCTETSTREAM,
												$disposition = mail_bank_Zend_Mime::DISPOSITION_ATTACHMENT,
												$encoding    = mail_bank_Zend_Mime::ENCODING_BASE64,
												$filename    = null)
	{
	...
	*/
	...
	/**
		* Sets Date-header
		*
		* @param	int|string|mail_bank_Zend_Date $date
		* @return mail_bank_Zend_Mail Provides fluent interface
