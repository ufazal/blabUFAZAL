...
class mail_bank_Zend_Registry extends ArrayObject
{
	/**
		...
		* @var string
	*/
	private static $_registryClassName = 'mail_bank_Zend_Registry';
	...
	*/
	public static function setClassName($registryClassName = 'mail_bank_Zend_Registry')
	{
		if(self::$_registry !== null)
		{
			if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/exception.php'))
		...
		*/
		if(!class_exists($registryClassName))
		{
			...
			mail_bank_Zend_Loader::loadClass($registryClassName);
		}
