...
class mail_bank_Zend_Mime_Message
{
	...
	*/
	...
	/**
		...
		*
		* @param mail_bank_Zend_Mime_Part $part
	*/
	public function addPart(mail_bank_Zend_Mime_Part $part)
	{
		/**
	...
	*/
	...
	/**
		...
		*
		* @param mail_bank_Zend_Mime $mime
	*/
	public function setMime(mail_bank_Zend_Mime $mime)
	{
		$this->_mime = $mime;
	}
	...
	*/
	...
	/**
		...
		* {@link setMime()} has been called before this method, the mail_bank_Zend_Mime
		...
		* @return string
	*/
	public function generateMessage($EOL = mail_bank_Zend_Mime::LINEEND)
	{
		if(!$this->isMultiPart())
		{
	...
	*/
	...
	/**
		...
		* @return string
	*/
	public function getPartHeaders($partnum, $EOL = mail_bank_Zend_Mime::LINEEND)
	{
	...
	/**
		...
		* @return string
	*/
	public function getPartContent($partnum, $EOL = mail_bank_Zend_Mime::LINEEND)
	{
	...
	/**
		...
		* @throws mail_bank_Zend_Exception
		* @return array
	*/
	...
	*/
	...
	{
		if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mime/decode.php'))
		require_once MAIL_BANK_DIR_PATH.'lib/zend/mime/decode.php';

		$parts = mail_bank_Zend_Mime_Decode::splitMessageStruct($message, $boundary, $EOL);

		$res = new self();
		foreach($parts as $part)
		{
			// now we build a new MimePart for the current Message Part:
			$newPart = new mail_bank_Zend_Mime_Part($part['body']);
