...
class mail_bank_Zend_Mime_Part
{
	...
	*/
	public function getEncodedStream()
	{
		if(!$this->_isStream)
		{
			if(file_exists(MAIL_BANK_DIR_PATH.'lib/zend/mime/exception.php'))
			require_once MAIL_BANK_DIR_PATH.'lib/zend/mime/exception.php';
	...
	/**
		...
		* @throws mail_bank_Zend_Mime_Exception
		* @return string
	*/
	public function getContent($EOL = mail_bank_Zend_Mime::LINEEND)
	{
		if($this->_isStream)
		{
	...
	*/
	...
	/**
		...
		* @return array
	*/
	public function getHeadersArray($EOL = mail_bank_Zend_Mime::LINEEND)
	{
		$headers = array();
	...
	/**
		...
		* @return string
	*/
	public function getHeaders($EOL = mail_bank_Zend_Mime::LINEEND)
	{
		$res = '';
