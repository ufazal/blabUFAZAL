...
function bf_widgets_init() {
	...
	register_sidebar(array(
		'name'          		=> __('Homepage Video Link', 'bluelinerfoundation' ),
		'id'         				=> 'homepagevideo-widget',
		'description'   		=> __( 'Homepage Video link on header', 'bluelinerfoundation' ),
		'before_widget' 	=> '',
		'after_widget' 		=> '',
		'before_title' 		=> '',
		'after_title' 			=> '',
	...
	register_sidebar(array(
		'name'          		=> __('Napoleon Link', 'bluelinerfoundation' ),
		'id'         				=> 'napoleon-widget',
		'description'   		=> __( 'Napoleon link on header', 'bluelinerfoundation' ),
		'before_widget' 	=> '',
		'after_widget' 		=> '',
		'before_title' 		=> '',
		'after_title' 			=> '',
