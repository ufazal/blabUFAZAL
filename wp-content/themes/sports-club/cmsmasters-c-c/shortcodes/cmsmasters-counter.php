...
if ($color != '') {
	$style_counters .= '#cmsmasters_counter_' . $unique_id . ' .cmsmasters_counter_counter, #cmsmasters_counter_' . $unique_id . ' .cmsmasters_counter_prefix, #cmsmasters_counter_' . $unique_id . ' .cmsmasters_counter_suffix { ' . 
