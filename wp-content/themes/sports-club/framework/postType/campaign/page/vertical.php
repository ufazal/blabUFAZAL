...
global $cmsmasters_featured_campaign_metadata;

$cmsmasters_metadata = explode(',', $cmsmasters_featured_campaign_metadata);
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	if ($image) {
		echo '<div class="cmsmasters_campaign_wrap_img">';
			cmsmasters_thumb_rollover($camp->ID, 'project-thumb', false, $link, false, false, false, false, false, false, true, false, false);
		echo '</div>';
	}
