...
global $cmsmasters_donation_metadata;
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="cmsmasters_donation_cont_wrap">
		<?php 
		if ($image) {
			cmsmasters_thumb_rollover(get_the_ID(), 'project-thumb', false, $link, false, false, false, false, false, false, true, false, false, 'cmsmasters_theme_icon_person');
		}
		?>
		<div class="cmsmasters_donation_cont">
			<?php 
			cmsmasters_donation_heading(get_the_ID(), 'h4', $link);
