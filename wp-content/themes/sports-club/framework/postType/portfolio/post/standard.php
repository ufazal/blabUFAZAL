		...
		?>
				...
				<?php 
					foreach ($cmsmasters_project_images as $cmsmasters_project_image) {
						...
						echo '<div>' . 
							'<figure>' . 
								wp_get_attachment_image($cmsmasters_project_image, 'full', false, array( 
									'class' => 'full-width', 
			...
			<?php 
				...
				cmsmasters_thumb(get_the_ID(), 'full', false, 'img_' . get_the_ID(), true, true, false, true, $cmsmasters_project_images[0]);
