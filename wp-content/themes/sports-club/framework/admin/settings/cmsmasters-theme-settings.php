...
function cmsmasters_get_settings() {
	...
	case CMSMASTERS_PAGE_BASENAME:
		...
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'sports-club');
	...
	case CMSMASTERS_PAGE_BASENAME . '-font':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'sports-club');
	...
	case CMSMASTERS_PAGE_BASENAME . '-color':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'sports-club');
	...
	case CMSMASTERS_PAGE_BASENAME . '-element':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'sports-club');	
	...
	case CMSMASTERS_PAGE_BASENAME . '-single':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'sports-club');
	...
	case CMSMASTERS_PAGE_BASENAME . '-demo':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'sports-club');
...
function cmsmasters_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'sports-club'), 
		'desc' => 		esc_html__('This is a default description.', 'sports-club'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function cmsmasters_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'sports-club'), 
		'find' => 				esc_attr__('Find icons', 'sports-club'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'sports-club'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			CMSMASTERS_SHORTNAME, 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'sports-club'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'sports-club') 
	));
...
function cmsmasters_add_menu() {
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'sports-club'), 
		esc_attr__('Theme Settings', 'sports-club'), 
		'manage_options', 
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme General Settings', 'sports-club'), 
		esc_attr__('General', 'sports-club'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME, 
		'cmsmasters_settings_page_fn' 
	);
	...
	$cmsmasters_settings_font = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Fonts Settings', 'sports-club'), 
		esc_attr__('Fonts', 'sports-club'), 
		'manage_options', 
	...
	$cmsmasters_settings_color = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Color Schemes', 'sports-club'), 
		esc_attr__('Colors', 'sports-club'), 
		'manage_options', 
	...
	$cmsmasters_settings_element = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Elements Settings', 'sports-club'), 
		esc_attr__('Elements', 'sports-club'), 
		'manage_options', 
	...
	$cmsmasters_settings_single = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Single Posts Settings', 'sports-club'), 
		esc_attr__('Single Posts', 'sports-club'), 
		'manage_options', 
	...
	$cmsmasters_settings_demo = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Settings Import/Export', 'sports-club'), 
		esc_attr__('Import/Export', 'sports-club'), 
		'manage_options', 
...
function cmsmasters_settings_page_fn() {
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'sports-club') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'sports-club') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'sports-club') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function cmsmasters_form_field_fn($args = array()) {
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'sports-club') . '" data-title="' . esc_attr__('Choose Image', 'sports-club') . '" data-button="' . esc_attr__('Insert Image', 'sports-club') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" alt="" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'sports-club') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'sports-club') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'sports-club') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'sports-club') . ' <em>(' . esc_html__('in pixels', 'sports-club') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'sports-club') . ' <em>(' . esc_html__('in pixels', 'sports-club') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'sports-club') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'sports-club') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'sports-club') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'sports-club') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'sports-club') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'sports-club') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'sports-club') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'sports-club') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'sports-club') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'sports-club') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'sports-club') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'sports-club') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'sports-club') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'sports-club') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'sports-club') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'sports-club') . '"></a> ' . 
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'sports-club');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						CMSMASTERS_SHORTNAME . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'sports-club'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'sports-club');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						...
						esc_html__('Expecting comma separated numeric values! Please fix.','sports-club'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'sports-club');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'sports-club');
				}
				...
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						...
						esc_html__('Please enter a valid email address.', 'sports-club'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'sports-club');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Theme Settings', 'sports-club'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('General', 'sports-club'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Fonts', 'sports-club'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Colors', 'sports-club'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Elements', 'sports-club'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Single', 'sports-club'), 
...
function cmsmasters_get_global($id) {
	...
	if (!isset($cmsmasters_global_options)) {
		$cmsmasters_global_options = cmsmasters_get_global_options();
	}
	
	
	return isset($cmsmasters_global_options[CMSMASTERS_SHORTNAME . '_' . $id]) ? $cmsmasters_global_options[CMSMASTERS_SHORTNAME . '_' . $id] : false;
}
