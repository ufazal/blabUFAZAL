...
(function ($) { 
	...
	if ($('input[id^="' + cmsmasters_settings.shortname + '_logo_type"]:checked').val() === 'image') {
		...
		$('#' + cmsmasters_settings.shortname + '_logo_mini_url').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_logo_mini_url_retina').parents('tr').hide();
	...
	$('input[id^="' + cmsmasters_settings.shortname + '_logo_type"]').on('change', function () { 
		if ($(this).is(':checked') && $(this).val() === 'image') {
			...
			$('#' + cmsmasters_settings.shortname + '_logo_mini_url').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_logo_mini_url_retina').parents('tr').show();
