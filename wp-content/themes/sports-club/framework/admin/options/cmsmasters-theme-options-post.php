...
$tabs_array['cmsmasters_post'] = array( 
	'label' => esc_html__('Post', 'sports-club'), 
...
$custom_post_meta_fields = array( 
	...
	array( 
		'label'	=> esc_html__('Post Image', 'sports-club'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Post Gallery', 'sports-club'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Audio Links', 'sports-club'), 
		'desc'	=> '', 
	...
	array( 
		'label'	=> esc_html__('Post Options', 'sports-club'), 
		'desc'	=> '', 
		'id'	=> $cmsmasters_option_name . 'post_options', 
		'type'	=> 'select', 
		'hide'	=> '', 
		'std'	=> 'default', 
		'options' => array( 
			'default' => array( 
				'label' => esc_html__('Use Default Post Options', 'sports-club'),
				'value'	=> 'default' 
			), 
			'custom' => array( 
				'label' => esc_html__('Set Custom Post Options', 'sports-club'),
				'value'	=> 'custom' 
			) 
		) 
	), 
	array( 
		'label'	=> esc_html__('Post Title', 'sports-club'), 
	...
	array( 
		'label'	=> esc_html__('More Posts Box', 'sports-club'), 
		'desc'	=> '', 
		...
		'options' => array( 
			'related' => array( 
				'label' => esc_html__('Show Related Posts Box', 'sports-club'), 
				'value'	=> 'related' 
			), 
			'popular' => array( 
				'label' => esc_html__('Show Popular Posts Box', 'sports-club'), 
				'value'	=> 'popular' 
			), 
			'recent' => array( 
				'label' => esc_html__('Show Recent Posts Box', 'sports-club'), 
				'value'	=> 'recent' 
			) 
		) 
	), 
