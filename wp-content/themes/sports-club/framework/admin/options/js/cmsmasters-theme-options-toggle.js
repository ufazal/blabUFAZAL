...
(function ($) { 
	$(document).ready(function () { 
		...
		if ($('input[name="cmsmasters_layout"]:checked').val() !== 'fullwidth') {
			...
			$('#cmsmasters_content_under_header').closest('tr').hide();
		}
		...
		$('input[name="cmsmasters_layout"]').on('change', function () { 
			if ($(this).val() === 'fullwidth') {
				...
				$('#cmsmasters_content_under_header').closest('tr').show();
		...
		$('#cmsmasters_bg_img_enable').bind('change', function () { 
			if ($(this).is(':checked')) {
				$('#cmsmasters_bg_img').closest('tr').show();
				$('#cmsmasters_bg_rep_no-repeat').closest('tr').show();
				$('#cmsmasters_bg_pos').closest('tr').show();
		...
		if ($('input[name="cmsmasters_heading"]:checked').val() === 'custom') {
			...
			$('#cmsmasters_heading_scheme').closest('tr').show();
		...
		$('input[name="cmsmasters_heading"]').on('change', function () { 
			if ($(this).val() === 'default') {
				...
				$('#cmsmasters_heading_scheme').closest('tr').hide();
  ...
  function cmsmasters_post_post_options_change() { 
   if ($('#cmsmasters_post_post_options').val() === 'custom') {
    $('#cmsmasters_post_title, #cmsmasters_post_sharing_box, #cmsmasters_post_author_box, #cmsmasters_post_more_posts').closest('tr').show();
   } else {
    $('#cmsmasters_post_title, #cmsmasters_post_sharing_box, #cmsmasters_post_author_box, #cmsmasters_post_more_posts').closest('tr').hide();
   }
  }
  
  /* Post Options Field Load Trigger */
  cmsmasters_post_post_options_change();
  
  /* Post Options Change Trigger */
  $('#cmsmasters_post_post_options').bind('change', cmsmasters_post_post_options_change);
  
  
  
  
		/* Project Options Change Function */
		function cmsmasters_project_project_options_change() { 
			if ($('#cmsmasters_project_project_options').val() === 'custom') {
				$('#cmsmasters_project_title, #cmsmasters_project_sharing_box, #cmsmasters_project_author_box, #cmsmasters_project_more_posts').closest('tr').show();
			} else {
				$('#cmsmasters_project_title, #cmsmasters_project_sharing_box, #cmsmasters_project_author_box, #cmsmasters_project_more_posts').closest('tr').hide();
			}
		}
		
		/* Project Options Field Load Trigger */
		cmsmasters_project_project_options_change();
		
		/* Project Options Change Trigger */
		$('#cmsmasters_project_project_options').bind('change', cmsmasters_project_project_options_change);
