 ...
 */
!function(e){"use strict";e.fn.cmsmastersFixedHeaderScroll=function(i){var t={headerTop:".header_top",headerMid:".header_mid",headerBot:".header_bot",navBlock:"nav",navList:"#navigation",headerTopRight:".header_top_right",navTopList:"#top_line_nav",respNavButton:".responsive_nav",respTopNavButton:".responsive_top_nav",fixedClass:".fixed_header",fixedClassBlock:"#page",respHideBlocks:"",maxWidthMid:1e3,maxWidthBot:1e3,changeTopHeight:!0,changeMidHeight:!0,mobileDisabled:!0},o=this,a={};a={init:function(){a.options=a.o=e.extend({},t,i),a.el=o,a.vars=a.v={},a.v.newTopHeight=0,a.v.newMidHeight=50,a.setHeaderVars(),a.startHeader()},setHeaderVars:function(){a.v.headerMidString=a.o.headerMid,a.v.headerTop=a.el.find("> "+a.o.headerTop),a.v.headerMid=a.el.find("> "+a.v.headerMidString),a.v.headerBot=a.el.find("> "+a.o.headerBot),a.v.respNavButton=a.el.find(a.o.respNavButton),a.v.headerTopRight=a.el.find(a.o.headerTopRight),a.v.respTopNavButton=a.el.find(a.o.respTopNavButton),a.v.respHideBlocks=e(a.o.respHideBlocks),a.v.navListString=a.o.navList,a.v.navTopListString=a.o.navTopList,a.v.navBlockString=a.o.navBlock,a.v.navBlock=a.el.find(a.v.navListString).parents(a.v.navBlockString),a.v.navTopBlock=a.el.find(a.v.navTopListString).parents(a.v.navBlockString),a.v.midChangeHeightBlocksResp=e(a.v.headerMidString+", "+a.v.headerMidString+" .header_mid_outer, "+a.v.headerMidString+" "+a.v.navListString+", "+a.v.headerMidString+" "+a.v.navListString+" > li, "+a.v.headerMidString+" "+a.v.navListString+" > li > a, "+a.v.headerMidString+" "+a.v.navListString+" > li > a > span.nav_bg_clr"),a.v.topHeight=0,a.v.midHeight=0,a.v.botHeight=0,a.v.win=e(window),a.v.winScrollTop=a.v.win.scrollTop(),a.v.winMidScrollTop=a.v.winScrollTop-a.v.topHeight-a.v.midHeight,a.v.isMobile="ontouchstart"in document.documentElement},startHeader:function(){a.v.headerTop.length>0&&(a.v.topHeight=Number(a.v.headerTop.attr("data-height"))),a.v.headerMid.length>0&&(a.v.midHeight=Number(a.v.headerMid.attr("data-height"))),a.v.headerBot.length>0&&(a.v.botHeight=Number(a.v.headerBot.attr("data-height"))),0==a.v.winScrollTop&&a.el.css({opacity:1}),a.attachEvents(),a.v.win.trigger("scroll")},attachEvents:function(){a.v.respNavButton.bind("click",function(){return a.v.respNavButton.is(":not(.active)")?(a.v.navBlock.css({display:"block"}),a.v.respHideBlocks.css({display:"none"}),a.v.respNavButton.addClass("active")):(a.v.navBlock.css({display:"none"}),a.v.respHideBlocks.css({display:"block"}),a.v.respNavButton.removeClass("active")),!1}),a.v.respTopNavButton.bind("click",function(){return a.v.respTopNavButton.is(":not(.active)")?(a.v.navTopBlock.css({display:"block"}),a.v.headerTopRight.addClass("active"),a.v.respHideBlocks.css({display:"none"}),a.v.respTopNavButton.addClass("active")):(a.v.navTopBlock.css({display:"none"}),a.v.respHideBlocks.css({display:"block"}),a.v.respTopNavButton.removeClass("active"),a.v.headerTopRight.removeClass("active")),!1}),a.v.win.bind("scroll",function(){return a.el.parents(a.o.fixedClassBlock).is(":not("+a.o.fixedClass+")")||a.o.mobileDisabled&&a.v.isMobile?!1:void(a.v.win.width()>a.o.maxWidthMid&&a.getScrollTop())}),a.v.win.bind("resize",function(){a.headerResize(a.v.headerBot.length>0?a.o.maxWidthBot:a.o.maxWidthMid)})},getScrollTop:function(){if(document.getElementsByClassName("enable_header_bottom")[0])var e=a.v.botHeight;else var e=a.v.midHeight/2.41;a.v.winScrollTop=a.v.win.scrollTop(),a.v.winMidScrollTop=a.v.winScrollTop-a.v.topHeight-a.v.midHeight,a.v.winScrollTop>a.v.topHeight+a.v.midHeight+a.v.botHeight?(a.el.css({marginTop:-(a.v.topHeight+a.v.midHeight/2.41+a.v.botHeight),paddingTop:e,opacity:1}).addClass("navi_scrolled"),jQuery("#page").find(".cmsmasters_dynamic_cart").addClass("cmsmasters_dynamic_cart_scrolled")):(a.el.removeClass("navi_scrolled").css({marginTop:-a.v.winScrollTop,paddingTop:0,opacity:1}),jQuery("#page").find(".cmsmasters_dynamic_cart").removeClass("cmsmasters_dynamic_cart_scrolled"))},headerResize:function(e){a.v.win.width()>e?(a.v.navBlock.removeAttr("style"),a.v.respHideBlocks.removeAttr("style"),a.v.respNavButton.removeClass("active"),a.getScrollTop()):a.el.removeAttr("style").removeClass("navi_scrolled").css({opacity:1})}},a.init()}}(jQuery);
