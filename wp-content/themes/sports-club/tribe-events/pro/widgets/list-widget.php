...
if ( isset( $posts ) && $posts ) : ?>
	...
	<p class="tribe-events-widget-link">
		<a href="<?php echo esc_attr( esc_url( $link_to_all ) ) ?>" rel="bookmark">
			<?php esc_html_e( 'View More&hellip;', 'sports-club' ) ?>
		</a>
	</p>
...
?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'sports-club' ), strtolower( tribe_get_event_label_plural() ) ); ?></p>
<?php
endif;
