...
<h3 class="tribe-events-visuallyhidden"><?php esc_html_e( 'This Week Navigation', 'sports-club' ); ?></h3>
<!-- .tribe-events-sub-nav -->
<ul class="tribe-events-sub-nav">
	<!-- .tribe-events-nav-previous -->
	<li class="tribe-this-week-nav-link cmsmasters_theme_icon_slide_prev nav-previous">
		<?php echo tribe_events_this_week_previous_link( $start_date ); ?>
	</li>

	<!-- .tribe-events-nav-next -->
	<li class="tribe-this-week-nav-link cmsmasters_theme_icon_slide_next nav-next">
