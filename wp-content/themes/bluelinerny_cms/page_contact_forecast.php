<?php  ?><?php
/*
Template Name: Contact Digital Forecast
*/
?>
<?php get_header(); ?>
...
day = new Date();
id = day.getTime();
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=475,height=175,left = 722.5,top = 512.5');");
}
// End -->
</script>
