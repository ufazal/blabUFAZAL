...
Template Name: Contact Digital Forecast Thank You
    ...
    <div id="content_right">
     ...
     <div id="text_header">
      ...
      <div id="page_widecontact">
		...
		$the_content = str_replace("<first-name>", $_COOKIE['thanks-fname'],$post->post_content);

		//setcookie("thanks-fname",'', time()+3600, "/", str_replace('http://www','',get_bloginfo('url'))); 
