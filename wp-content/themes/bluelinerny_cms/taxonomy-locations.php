...
?>
      <style type="text/css">
<!--
ul.sortby { clear: both; width: 100%; margin: 4px; padding: 4px;  display: block; height: 25px; line-height: 20px; }
.sortby li{ font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin: 3px; padding: 3px; float: left; display: inline; }
-->
</style>
      <ul class="sortby">
        <li>Sort By: </li>
...
query_posts($query_string . "&order=ASC" . "&posts_per_page=30");
 ?>
