...
<?php if ( comments_open() ) {
	comment_form( array( 'comment_notes_before' => "<p>" . __('Keep the conversation going by both adding your comments and by passing this along to three friends.<br />That&acute;s how things get better.', 'cudazi') . "</p>", 'title_reply' => 'What do you think?', 'logged_in_as' => '<p>Keep the conversation going by both adding your comments and by passing this along to three friends.<br />That&acute;s how things get better.</p><p class="logged-in-as">' . sprintf( __( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>' ) ); 
} ?>
