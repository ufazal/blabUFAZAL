		...
		<div class="wrap">
			...
			<thead>
				...
				<tr class="<?php echo $alt?>">
					...
					<td><a href="javascript:void(0);" onclick="return remove_sidebar_link('<?php echo $sidebar; ?>',<?php echo $cnt+1; ?>);" title="Remove this sidebar" class="submitdelete deletion">remove</a></td>
				</tr>
				<?php
						$cnt++;
					}
