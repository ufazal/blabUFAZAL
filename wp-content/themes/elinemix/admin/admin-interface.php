  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
        ...
        <p>For future updates follow me <a  href="http://themeforest.net/user/madza/flollow">@themeforest</a> or <a target="_blank" href="http://twitter.com/#!/madzathemes">@twitter</a></p>
      </div>
...
function of_load_only() {
    ...
    wp_enqueue_script('cufon', OF_DIRECTORY.'/includes/cufon-yui.js', array('jquery'));
    wp_enqueue_script('colaborate', OF_DIRECTORY.'/includes/fonts/ColaborateLight_400.font.js', array('jquery'));
...
Cufon.replace('.logo h2, .line_title h3', {hover: true});
			jQuery(document).ready(function(){
		...
		//Start Heading
         ...
         if ( $value['type'] == "line" ){
			...
			$output .= '<div class="section section-'.$value['type'].' '. $class .'">'."\n";
    			...
    			//$output .= '<div class="section section-'. $value['type'] .'">'."\n".'<div class="option-inner">'."\n";
    			$output .= '<div class="section section-'.$value['type'].' '. $class .'">'."\n";
    			$output .= '<div class="heading-left"><h4 class="heading">'. $value['name'] .'</h4>'."\n";
                if ( $value['type'] == "line" ){} else {
                if(!isset($value['desc'])){ $explain_value = ''; } else{ $explain_value = $value['desc']; } 
    			$output .= '<div class="explain">'. $explain_value .'</div></div>'."\n";
			}
                $output .= '<div class="option">'."\n" . '<div class="controls">'."\n";
            }
