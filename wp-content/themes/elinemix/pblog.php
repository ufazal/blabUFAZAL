<?php
/*
Template Name: president's blog
*/
get_header(); 

	$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
	  query_posts('paged=' . $paged . '&cat=10'); 
?>
<div class="<?php 
...
if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
    ...
    <div class="small-image-diver"> 		
        ...
        <h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
         ...
         <?php /*?><div class="post-small-image"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s'), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail('post_small_image');?></a></div><?php */?>
