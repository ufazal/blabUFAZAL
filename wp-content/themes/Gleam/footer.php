				...
				if ( '' != $bg_image ){
					...
					foreach( $et_used_images as $et_attachment_id => $et_used_image ){
						...
						if ( $et_fullimage_array ){
							...
							echo 	'<li>
										<img src="' . esc_url( $et_fullimage ) . '" data-smallimage="' . esc_url( et_new_thumb_resize( et_multisite_thumbnail($et_fullimage ), 43, 43, '', true ) ) . '" data-image_title="' . esc_attr( $et_used_image['image_title'] ) . '" data-image_desc="' . esc_attr( $et_used_image['image_description'] ) . '" alt="" />
									</li>';
						}
					}
				}
